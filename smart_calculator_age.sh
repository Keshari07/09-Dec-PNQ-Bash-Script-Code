...
calculate_age() {
    ...
    # Display the results
    echo "Your age is approximately:"
    echo " - $age_in_seconds seconds"
    echo " - $age_in_minutes minutes"
    echo " - $age_in_hours hours"
    echo " - $age_in_days days"
    echo " - $age_in_months months"
    echo " - $age_in_years years"
}
